...
public class ApiRegHelper extends ApiHelperBase {
    ...
    public int getRegStatusCodeWithoutLastNameFromApi(UserReg user1) throws URISyntaxException, IOException {
        CloseableHttpClient client = HttpClients.createDefault();
        URIBuilder uriBuilder = new URIBuilder("https://api.leroymerlin.ru/mobile/user/register");
    ...
    public RegResponse getRegResponseWithoutLastNameFromApi(UserReg user1) throws IOException, URISyntaxException {
        RegResponse regResponse;
        String message = null;
        String stringCode = null;
    ...
    public RegResponse getRegResponseWithoutFirstNameFromApi(UserReg user1) throws URISyntaxException, IOException {
        RegResponse regResponse;
        String message = null;
        String stringCode = null;
