...
public class ApiRegHelper extends ApiHelperBase {
    ...
    public RegResponse getRegResponseFromApi(String json) throws IOException, URISyntaxException {
    ...
    public int getRegStatusCodeFromApi(String json) throws IOException, URISyntaxException {
